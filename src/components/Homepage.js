...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="bg-gradient-to-b from-gray-100 to-white py-24 bg-cover bg-center"
      style={{ backgroundImage: `url('/images/landing.jpg')` }}
    >
      <div className="container mx-auto flex flex-col items-center text-center px-4 bg-black bg-opacity-50 py-12">
